...
class CreateResetTokenHandler(AuthHandlerBase):
    ...
    def handle_action(self, request_data: dict, event: dict, context: dict):
        ...
        # Fire off the email.
        # self.send_reset_email(auth_user.user, reset_url)
    ...
    def send_reset_email(self, email: str, reset_url: str):
        ...
        email_props.text = f"Please click here to reset your account: {reset_url}"
        email_props.html = f"<div>Please click here to reset your account: <a href='{reset_url}'>Reset Account</a></div>"
